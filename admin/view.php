    ...
    <body>
        ...
        <main class="grid-container">
            <div class="grid-item">
                <h1>Profile</h1>
                <div class="profile">
                    <img src="../<?php echo $row['profile_image'] ?>" alt="doctor image" />
                    <div class="info">
                        ...
                        <p><strong>License Number: </strong><?php echo $row['license_number'] ?></p>
                        <p><strong>Eductaion: </strong><?php echo $row['education'] ?></p>
